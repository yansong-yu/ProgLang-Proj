...
public class Interpreter {
    ...
    public static void main(String[] args) {
        ...
        RecordYYS rec = astRoot.check();
        if (rec.statusCode == true){
            fatalError("Type Checking Success!", EXIT_SUCCESS);
        }else{
            fatalError("Type Checking Failed!", EXIT_STATIC_CHECKING_ERROR);
        }
    }
